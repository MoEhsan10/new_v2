...
class AppStyles{
  static final TextStyle appBar = GoogleFonts.exo(fontSize: 24.sp,color: ColorsManager.white,fontWeight: FontWeight.w400);
  ...
  static final TextStyle articleDescription = GoogleFonts.poppins(fontSize: 14.sp, fontWeight: FontWeight.w300, color: const Color(0xFF42505C));
